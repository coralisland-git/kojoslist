...
urlpatterns += [
    ...
    url(r"^place_country_list$", place_country_list, name="place_country_list"),
    ...
    url(r"^ads-message/(?P<ads_id>\d*)/(?P<client_id>\d*)", view_ads_message, name="view-ads-message"),
    ...
    url(r"^search-txs", search_txs, name="search-txs"),   
